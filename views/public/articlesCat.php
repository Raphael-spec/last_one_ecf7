...
<div class="container p-5 mt-3 mb-3" style="background-image: url('./assets/images/studio.jpg'); min-height:1000px">
    <div class="row my-3">
              <div class="col-8">
                          ...
                          <ul class="list-group">
                            ...
                            <form action="index.php?action=checkout" method="post">
                                ...
                                <input type="hidden"  name="prix" value="<?= $art->getPrix();?>">
                                  <button type="submit" name="envoi" class="btn btn-success text-white mt-2"> Acheter</button>
                            </form>
